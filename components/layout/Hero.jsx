...
export default function Hero() {
  return (
    <section className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-gradient-to-br from-lime-50 to-emerald-100 rounded-3xl shadow-xl py-16 px-4 md:px-12 my-8 overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-start gap-6 py-8 z-10">
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-emerald-700 drop-shadow mb-2">
          Everything is <br />
          Better with a <span className="text-emerald-500">Pizza</span>
        </h1>
