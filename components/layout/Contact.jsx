...
const Contact = () => {
	return (
		<section className="max-w-2xl mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl p-5 sm:p-8 md:p-12 mt-8 sm:mt-12 border border-lime-100">
