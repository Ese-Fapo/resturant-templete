...
const HomeMenu = () => {
  return (
   <section className="w-full bg-linear-to-br from-lime-50 to-green-100 py-12 sm:py-16 lg:py-20 px-3 sm:px-4 md:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-lime-700 drop-shadow mb-2 sm:mb-4 tracking-tight">Nosso Cardápio</h2>
        <p className="text-center text-base sm:text-lg text-gray-700 mb-8 sm:mb-12">Explore nossos deliciosos pratos</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          ...
          <div className="group bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-4 sm:p-6 flex flex-col items-center border border-lime-100 hover:border-lime-400">
            <div className="overflow-hidden rounded-xl sm:rounded-2xl w-full mb-3 sm:mb-4">
              <Image src="/images/pizza_in.jpeg" alt="Pizza Margherita" width={400} height={300} className="rounded-xl sm:rounded-2xl group-hover:scale-105 transition-transform duration-300" />
            </div>
          ...
          <div className="group bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-4 sm:p-6 flex flex-col items-center border border-lime-100 hover:border-lime-400">
            <div className="overflow-hidden rounded-xl sm:rounded-2xl w-full mb-3 sm:mb-4">
              <Image src="/images/pizza-1.jpeg" alt="Spaghetti Carbonara" width={400} height={300} className="rounded-xl sm:rounded-2xl group-hover:scale-105 transition-transform duration-300" />
            </div>
          ...
          <div className="group bg-white rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-4 sm:p-6 flex flex-col items-center border border-lime-100 hover:border-lime-400">
            <div className="overflow-hidden rounded-xl sm:rounded-2xl w-full mb-3 sm:mb-4">
              <Image src="/images/pizzaria-1920.webp" alt="Caesar Salad" width={400} height={300} className="rounded-xl sm:rounded-2xl group-hover:scale-105 transition-transform duration-300" />
            </div>
